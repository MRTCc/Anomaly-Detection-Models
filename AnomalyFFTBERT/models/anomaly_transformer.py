...
from AnomalyFFTBERT.models.transformer import get_transformer_encoder
...
class TransformerEmbedder(nn.Module):
    ...
    """
    def __init__(self, in_features, seq_len, max_seq_len, out_features, dropout_prob=0.1, alpha=0.2):
...
# TODO : eliminare la variabile alpha (refuso dalla graph attention)
