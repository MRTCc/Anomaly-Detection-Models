...
def train(args_dict):
    parser = get_parser()
    options = parser.parse_args(args_dict)
...
def load(args_dict, model_path: str):
    # TODO: istanziare il modello in base agli argomenti di input
    parser = get_parser()
    options = parser.parse_args(args_dict)
...
if __name__ == "__main__":
    ...
    model = load(vals, r"C:\Users\martu\PycharmProjects\System.AI4AD\AnomalyFFTBERT\logs\prova_model.pth")
