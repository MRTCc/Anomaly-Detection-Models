...
def get_parser():
    ...
    # TODO: da cancellare, così è una porcata
    parser.add_argument("--train_label_path", type=str, help='train labels file path (.npy file expected)')
    ...
    parser.add_argument("--model_path", type=str, default="", help='path at which '
                                                            'the trained model parameters will be saved')
    parser.add_argument("--model_name", type=str)
    parser.add_argument("--result_path", type=str,  default="", help='path at which the test result will be saved')
    parser.add_argument("--metrics_path", type=str,  default="", help='path at which the evaluated test metrics results'
                                                         ' will be saved')
    parser.add_argument("--logs_path", default="logs/", type=str, help="path at which the log files will be saved")

    # numeric params
    parser.add_argument("--set_seed", default=False, type=bool, help="flag for setting random seed initialization: "
                                                                     "true -> set random seed for all "
                                                                     "numeric random generation ")
    parser.add_argument("--seed", default=0, type=int, help="seed for numeric random generation; "
                                                            "only used if the set_seed flag is active")
    parser.add_argument("--dtype", default="float32", type=str, help="default dtype used for the pytorch library")
