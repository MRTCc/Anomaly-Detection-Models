...
def get_parser():
    ...
    parser.add_argument("--model_path", type=str, help='path at which '
    ...
    parser.add_argument("--alpha", default=0.1, type=float, help="negative slope used in the LeakyReLU "
                                                                 "activation function of the graph attention layer.")
    parser.add_argument("--n_heads", default=3, type=int, help="number of the attention head in the"
